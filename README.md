<h1>Hi, my name is Shameka, an IT Professional</a></h1>

<h2> Information Technology Projects:</h2>

- <b>Virtual Private Networks (VPNs)</b>
  - [VPNs: Setup and Usage](https://github.com/labuser41/osticket-prereqs)
  - [VPNs: Testing the connection](https://github.com/labuser41/post-install-config)
